...
class Dir {
  constructor (outputDir, inputDir, name) {
    ...
    // TODO: color based on progress
    const createTask = new CustomTask(new TextAddon('Create dir'))
    this.task = new NameTask(this.page, new ConcatTask(customTask, createTask))
    this.create = outputDir.createDir(name)
