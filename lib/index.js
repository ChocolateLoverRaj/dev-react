...
class DevReact {
  constructor ({ inputDir, outputDir }) {
    ...
    this.emptyDirTask = new HideTask(this.emptyDir.task)
    this.dirs = new Dirs()
    this.closeChokidar = new HideTask(new CustomTask(new StateAddon(new TextAddon('Close chokidar'))))
    ...
    this.emitter = new EventEmitter()
      .on('start', async () => {
        ...
        this.emptyDirTask.hidden = false
